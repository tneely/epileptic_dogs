...
function [featsX, segY] = read_gen(windows,overlap,norm,spec_edge,sig_pow,avg_pow) 
    ...
    for i = 1:N
        ...
        featsX = [featsX; sing_feat_win(data,freq,windows,overlap,norm,spec_edge,sig_pow,avg_pow)];
